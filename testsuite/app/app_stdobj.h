...
#define OBJ1017_0(ref)                             \
    ...
    CO_THB_PROD, CO_DATA_INDIRECT(ref)
...
#define OBJ12XX_1(srv,ref)                                 \
    ...
    CO_TSDOID, CO_DATA_INDIRECT(ref)
...
#define OBJ14XX_1(num,ref)                                 \
    ...
    CO_TPDOID, CO_DATA_INDIRECT(ref)
...
#define OBJ14XX_2(num,ref)                                \
    ...
    CO_TPDOTYPE, CO_DATA_INDIRECT(ref)
...
#define OBJ16XX_0(num,ref)                                \
    ...
    CO_TPDONUM, CO_DATA_INDIRECT(ref)
...
#define OBJ16XX_N(num,map,ref)                                 \
    ...
    CO_TPDOMAP, CO_DATA_INDIRECT(ref)
...
#define OBJ18XX_5(num,ref)                                 \
    ...
    CO_TEVENT, CO_DATA_INDIRECT(ref)

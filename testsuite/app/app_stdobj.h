...
#define OBJ1005_0(ref)                             \
    ...
    CO_TSYNCID, CO_DATA_SET_REF(ref)
...
#define OBJ1006_0(ref)                             \
    ...
    CO_TSYNCCYCLE, CO_DATA_SET_REF(ref)
...
#define OBJ1014_0(ref)                             \
    ...
    CO_TEMCYID, CO_DATA_SET_REF(ref)
...
#define OBJ1017_0(ref)                             \
    ...
    CO_THB_PROD, CO_DATA_SET_REF(ref)
...
#define OBJ14XX_2(num,ref)                                \
    ...
    CO_TPDOTYPE, CO_DATA_SET_REF(ref)
...
#define OBJ16XX_0(num,ref)                                \
    ...
    CO_TPDONUM, CO_DATA_SET_REF(ref)
...
#define OBJ16XX_N(num,map,ref)                                 \
    ...
    CO_TPDOMAP, CO_DATA_SET_REF(ref)

...
TS_DEF_MAIN(TS_ExpRd_1BytePara)
{
    ...
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED8|CO_OBJ____RW), 0, CO_DATA_SET_REF(&val));
...
TS_DEF_MAIN(TS_ExpRd_2BytePara)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_4BytePara)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_1ByteVar)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED8|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_2ByteVar)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED16|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_4ByteVar)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED32|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_4ByteConst)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED32|CO_OBJ_D__R_), 0, CO_DATA_SET_VAL(0x44434241));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_4ByteConstNodeId)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED32 | CO_OBJ_DN_R_), 0, CO_DATA_SET_VAL(0x44434241));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_2ByteParaNodeId)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED16|CO_OBJ__NPRW), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_WriteOnly)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED16|CO_OBJ_____W), 0, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_DataNullPtr)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_VAL(0));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_ExpRd_UserReadErr)
{
    ...
    /* -- PREPARATION -- */
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(idx, sub, CO_UNSIGNED8|CO_OBJ____RW), MY_TYPE, CO_DATA_SET_REF(&val));
    TS_CreateNode(&node,0);

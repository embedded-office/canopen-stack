...
TS_DEF_MAIN(TS_TPdo_8x1Byte)
{
    ...
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x0C, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[1]));
    TS_ODAdd(CO_KEY(0x2500, 0x0D, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[2]));
    TS_ODAdd(CO_KEY(0x2500, 0x0E, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[3]));
    TS_ODAdd(CO_KEY(0x2500, 0x0F, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[4]));
    TS_ODAdd(CO_KEY(0x2500, 0x10, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[5]));
    TS_ODAdd(CO_KEY(0x2500, 0x11, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[6]));
    TS_ODAdd(CO_KEY(0x2500, 0x12, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[7]));
...
TS_DEF_MAIN(TS_TPdo_4x2Byte)
{
    ...
    TS_CreateTPdoCom(0, &tpdo_id, &tpdo_type, &tpdo_inhibit, &tpdo_evtime);
    TS_CreateTPdoMap(0, &tpdo_map[0], &tpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED16|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x16, CO_UNSIGNED16|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[1]));
    TS_ODAdd(CO_KEY(0x2500, 0x17, CO_UNSIGNED16|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[2]));
    TS_ODAdd(CO_KEY(0x2500, 0x18, CO_UNSIGNED16|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[3]));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_TPdo_2x4Byte)
{
    ...
    TS_CreateTPdoCom(0, &tpdo_id, &tpdo_type, &tpdo_inhibit, &tpdo_evtime);
    TS_CreateTPdoMap(0, &tpdo_map[0], &tpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x1F, CO_UNSIGNED32|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x20, CO_UNSIGNED32|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data[1]));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_TPdo_1_2_4Byte)
{
    ...
    TS_CreateTPdoCom(0, &tpdo_id, &tpdo_type, &tpdo_inhibit, &tpdo_evtime);
    TS_CreateTPdoMap(0, &tpdo_map[0], &tpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data8));
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED16|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data16));
    TS_ODAdd(CO_KEY(0x2500, 0x1F, CO_UNSIGNED32|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data32));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_TPdo_24Bit)
{
    ...
    TS_CreateTPdoCom(0, &tpdo_id, &tpdo_type, &tpdo_inhibit, &tpdo_evtime);
    TS_CreateTPdoMap(0, &tpdo_map[0], &tpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED32|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data24));
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED32|CO_OBJ___PRW), 0, CO_DATA_SET_REF(&data32));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_TPdo_Async)
{
    ...
    TS_CreateTPdoCom(0, &tpdo_id, &tpdo_type, &tpdo_inhibit, &tpdo_evtime);
    TS_CreateTPdoMap(0, &tpdo_map[0], &tpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x29, CO_UNSIGNED32|CO_OBJ___PRW), CO_TASYNC, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x2A, CO_UNSIGNED32|CO_OBJ___PRW),         0, CO_DATA_SET_REF(&data[1]));
    TS_CreateNodeAutoStart(&node);

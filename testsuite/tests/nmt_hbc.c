...
TS_DEF_MAIN(TS_HBCons_RdEntry)
{
    ...
    TS_ODAdd(CO_KEY(0x1016, 0, CO_UNSIGNED8|CO_OBJ_D__R_), 0, CO_DATA_DIRECT(1));
    TS_ODAdd(CO_KEY(0x1016, 1, CO_UNSIGNED32|CO_OBJ____R_), CO_THB_CONS, CO_DATA_INDIRECT(&data));
...
TS_DEF_MAIN(TS_HBCons_MultiConsumer)
{
    ...
    data2.Time   = 70;
                                                      /*------------------------------------------*/
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(0x1016, 0, CO_UNSIGNED8|CO_OBJ_D__R_), 0, CO_DATA_DIRECT(2));
    TS_ODAdd(CO_KEY(0x1016, 1, CO_UNSIGNED32|CO_OBJ____R_), CO_THB_CONS, CO_DATA_INDIRECT(&data1));
    TS_ODAdd(CO_KEY(0x1016, 2, CO_UNSIGNED32|CO_OBJ____R_), CO_THB_CONS, CO_DATA_INDIRECT(&data2));
    TS_CreateNode(&node,0);
                                                      /*------------------------------------------*/
    TS_HB_SEND(10, 5);
    TS_HB_SEND(20, 5);
...
TS_DEF_MAIN(TS_HBCons_WrEntry)
{
    ...
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(0x1016, 0, CO_UNSIGNED8|CO_OBJ_D__R_), 0,CO_DATA_DIRECT(1));
    TS_ODAdd(CO_KEY(0x1016, 1, CO_UNSIGNED32|CO_OBJ____RW), CO_THB_CONS, CO_DATA_INDIRECT(&data));
    TS_CreateNode(&node,0);
                                                      /*------------------------------------------*/

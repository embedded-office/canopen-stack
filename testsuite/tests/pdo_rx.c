...
TS_DEF_MAIN(TS_RPdo_8x1Byte)
{
    ...
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x0C, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[1]));
    TS_ODAdd(CO_KEY(0x2500, 0x0D, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[2]));
    TS_ODAdd(CO_KEY(0x2500, 0x0E, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[3]));
    TS_ODAdd(CO_KEY(0x2500, 0x0F, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[4]));
    TS_ODAdd(CO_KEY(0x2500, 0x10, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[5]));
    TS_ODAdd(CO_KEY(0x2500, 0x11, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[6]));
    TS_ODAdd(CO_KEY(0x2500, 0x12, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[7]));
...
TS_DEF_MAIN(TS_RPdo_4x2Byte)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x16, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[1]));
    TS_ODAdd(CO_KEY(0x2500, 0x17, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[2]));
    TS_ODAdd(CO_KEY(0x2500, 0x18, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[3]));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_2x4Byte)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x1F, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x20, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data[1]));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_1_2_4Byte)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data8));
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data16));
    TS_ODAdd(CO_KEY(0x2500, 0x1F, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data32));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_UpdateAfterSync)
{
    ...
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_INDIRECT(&data));
    TS_CreateNodeAutoStart(&node);

...
TS_DEF_MAIN(TS_RPdo_8x1Byte)
{
    ...
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x0C, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[1]));
    TS_ODAdd(CO_KEY(0x2500, 0x0D, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[2]));
    TS_ODAdd(CO_KEY(0x2500, 0x0E, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[3]));
    TS_ODAdd(CO_KEY(0x2500, 0x0F, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[4]));
    TS_ODAdd(CO_KEY(0x2500, 0x10, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[5]));
    TS_ODAdd(CO_KEY(0x2500, 0x11, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[6]));
    TS_ODAdd(CO_KEY(0x2500, 0x12, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[7]));
...
TS_DEF_MAIN(TS_RPdo_4x2Byte)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x16, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[1]));
    TS_ODAdd(CO_KEY(0x2500, 0x17, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[2]));
    TS_ODAdd(CO_KEY(0x2500, 0x18, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[3]));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_2x4Byte)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x1F, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 0x20, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data[1]));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_1_2_4Byte)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data8));
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED16|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data16));
    TS_ODAdd(CO_KEY(0x2500, 0x1F, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data32));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_24Bit)
{
    ...
    TS_CreateRPdoCom(0, &rpdo_id,     &rpdo_type);
    TS_CreateRPdoMap(0, &rpdo_map[0], &rpdo_len);
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data24));
    TS_ODAdd(CO_KEY(0x2500, 0x15, CO_UNSIGNED32|CO_OBJ____RW), 0, CO_DATA_SET_REF(&data32));
    TS_CreateNodeAutoStart(&node);
...
TS_DEF_MAIN(TS_RPdo_UpdateAfterSync)
{
    ...
    TS_ODAdd(CO_KEY(0x2500, 0x0B, CO_UNSIGNED8 |CO_OBJ____RW), 0, CO_DATA_SET_REF(&data));
    TS_CreateNodeAutoStart(&node);

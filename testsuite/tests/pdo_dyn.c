...
TS_DEF_MAIN(TS_RPdo_BadIdSubIdxCfg)
{
    ...
    TS_CreateRPdoCom(0, &pdo_id, &pdo_type);
    TS_CreateRPdoMap(0, 0, &pdo_len);
    TS_ODAdd(CO_KEY(0x1400, 3, CO_UNSIGNED32|CO_OBJ__N_RW), CO_TPDOID, CO_DATA_INDIRECT(&pdo_id));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_TPdo_BadIdSubIdxCfg)
{
    ...
    TS_CreateMandatoryDir();
    TS_CreateTPdoCom(0, &pdo_id, &pdo_type, &pdo_inhibit, &pdo_evtimer);
    TS_ODAdd(CO_KEY(0x1800, 6, CO_UNSIGNED32|CO_OBJ__N_RW), CO_TPDOID, CO_DATA_INDIRECT(&pdo_id));
    TS_CreateTPdoMap(0, 0, &pdo_len);
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_RPdo_BadIdIdxCfg)
{
    ...
    TS_CreateRPdoCom(0, &pdo_id, &pdo_type);
    TS_CreateRPdoMap(0, 0, &pdo_len);
    TS_ODAdd(CO_KEY(0x2502, 1, CO_UNSIGNED32|CO_OBJ__N_RW), CO_TPDOID, CO_DATA_INDIRECT(&pdo_id));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_TPdo_BadIdIdxCfg)
{
    ...
    TS_CreateMandatoryDir();
    TS_CreateTPdoCom(0, &pdo_id, &pdo_type, &pdo_inhibit, &pdo_evtimer);
    TS_ODAdd(CO_KEY(0x2501, 1, CO_UNSIGNED32|CO_OBJ__N_RW), CO_TPDOID, CO_DATA_INDIRECT(&pdo_id));
    TS_CreateTPdoMap(0, 0, &pdo_len);
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_RPdo_MapNumChange)
{
    ...
    TS_ODAdd(CO_KEY(0x2500, 31, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_INDIRECT(&data[0]));
    TS_ODAdd(CO_KEY(0x2500, 32, CO_UNSIGNED8 |CO_OBJ___PRW), 0, CO_DATA_INDIRECT(&data[1]));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_TPdo_BadMapNumSubIdxCfg)
{
    ...
    TS_CreateTPdoCom(0, &pdo_id, &pdo_type, &pdo_inhibit, &pdo_evtimer);
    TS_CreateTPdoMap(0, 0, &pdo_len);
    TS_ODAdd(CO_KEY(0x1A00, 9, CO_UNSIGNED8 |CO_OBJ____RW), CO_TPDONUM, CO_DATA_INDIRECT(&pdo_len));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_RPdo_BadMapNumIdxCfg)
{
    ...
    TS_CreateRPdoCom(0, &pdo_id, &pdo_type);
    TS_CreateRPdoMap(0, &pdo_map[0], &pdo_len);
    TS_ODAdd(CO_KEY(0x2503, 0, CO_UNSIGNED32|CO_OBJ____RW), CO_TPDONUM, CO_DATA_INDIRECT(&pdo_len));
    TS_CreateNode(&node,0);
...
TS_DEF_MAIN(TS_TPdo_BadMapNumIdxCfg)
{
    ...
    TS_CreateTPdoCom(0, &pdo_id, &pdo_type, &pdo_inhibit, &pdo_evtimer);
    TS_CreateTPdoMap(0, 0, &pdo_len);
    TS_ODAdd(CO_KEY(0x2504, 0, CO_UNSIGNED32|CO_OBJ____RW), CO_TPDONUM, CO_DATA_INDIRECT(&pdo_len));
    TS_CreateNode(&node,0);

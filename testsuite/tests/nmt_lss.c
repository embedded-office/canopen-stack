...
TS_DEF_MAIN(TS_Lss_SelIdent_WrongVendor)
{
    ...
    /*------------------------------------------*/
    TS_CreateMandatoryDir();
    TS_ODAdd(CO_KEY(0x1018, 1, CO_UNSIGNED32 | CO_OBJ____R_), 0, CO_DATA_SET_REF(&vendor));
    TS_ODAdd(CO_KEY(0x1018, 2, CO_UNSIGNED32 | CO_OBJ____R_), 0, CO_DATA_SET_REF(&product));
    TS_ODAdd(CO_KEY(0x1018, 3, CO_UNSIGNED32 | CO_OBJ____R_), 0, CO_DATA_SET_REF(&revision));
    TS_ODAdd(CO_KEY(0x1018, 4, CO_UNSIGNED32 | CO_OBJ____R_), 0, CO_DATA_SET_REF(&serial));
    TS_CreateNode(&node,0);
    /*------------------------------------------*/

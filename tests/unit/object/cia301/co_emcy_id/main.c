...
void test_size_unknown(void)
{
    CO_NODE  AppNode = { 0 };
    uint32_t data;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TEMCY_ID, (CO_DATA)(&data)};
    uint32_t size;
...
void test_read_direct(void)
{
    ...
    uint32_t val  = 0;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TEMCY_ID, (CO_DATA)(0x6677)};
...
{
    CO_NODE  AppNode = { 0 };
    uint32_t data = 0x88776655;                /* bit31 = 1: inactive ID */
    uint32_t val  = 0x88776655 & (0x7FFFFFFF); /* bit31 = 0: active ID */
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TEMCY_ID, (CO_DATA)(&data)};
...
void test_write_active(void)
{
    CO_NODE  AppNode = { 0 };
    uint32_t data = 0x55667788;   /* bit31 = 0: active ID */
    uint32_t val  = 0x11223344;   /* bit31 = 0: active ID */
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TEMCY_ID, (CO_DATA)(&data)};
...
void test_init_check(void)
{
    ...
    uint32_t data;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0x1014, 0, CO_OBJ_____RW), CO_TEMCY_ID, (CO_DATA)(&data)};
...
void test_init_bad_index(void)
{
    ...
    uint32_t data;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0x2345, 0, CO_OBJ_____RW), CO_TEMCY_ID, (CO_DATA)(&data)};
...
void test_init_bad_sub(void)
{
    ...
    uint32_t data;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0x1014, 12, CO_OBJ_____RW), CO_TEMCY_ID, (CO_DATA)(&data)};

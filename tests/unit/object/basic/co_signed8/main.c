...
void test_size_unknown(void)
{
    CO_NODE  AppNode = { 0 };
    int8_t   data = -11;
    CO_OBJ   Obj  = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TSIGNED8, (CO_DATA)(&data)};
    uint32_t size;
...
void test_size_known(void)
{
    ...
    size = COObjGetSize(&Obj, &AppNode, 1);
...
{
    CO_NODE AppNode = { 0 };
    CO_OBJ  Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TSIGNED8, (CO_DATA)(-22)};
    int8_t  var;
    CO_ERR  err;
...
void test_read_nodeid(void)
{
    CO_NODE AppNode = { 0 };
    int8_t  data = -33;
    CO_OBJ  Obj = { CO_KEY(0, 0, CO_OBJ__N__RW), CO_TSIGNED8, (CO_DATA)(&data)};
    int8_t  var;
    CO_ERR  err;
...
{
    int8_t  var = -44;
    CO_OBJ  Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TSIGNED8, (CO_DATA)(-11)};
    CO_ERR  err;
...
void test_write_pdo_async(void)
{
    CO_NODE AppNode = { 0 };
    int8_t  data = -33;
    CO_OBJ  Obj = { CO_KEY(0, 0, CO_OBJ___APRW), CO_TSIGNED8, (CO_DATA)(&data)};
    int8_t  var = -44;
    CO_ERR  err;
...
void test_write_pdo(void)
{
    CO_NODE AppNode = { 0 };
    int8_t  data = -33;
    CO_OBJ  Obj = { CO_KEY(0, 0, CO_OBJ____PRW), CO_TSIGNED8, (CO_DATA)(&data)};
    int8_t  var = -44;
    CO_ERR  err;

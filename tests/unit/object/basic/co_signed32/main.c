...
{
    CO_NODE  AppNode = { 0 };
    int32_t  data = -11223344;
    CO_OBJ   Obj  = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TSIGNED32, (CO_DATA)(&data)};
    uint32_t size;
...
{
    CO_NODE  AppNode = { 0 };
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TSIGNED32, (CO_DATA)(-22334455)};
    int32_t  var;
    CO_ERR   err;
    ...
    TEST_CHECK(err == CO_ERR_NONE);
    TEST_CHECK(var == -22334455);
}

void test_read_nodeid(void)
{
    CO_NODE  AppNode = { 0 };
    int32_t  data = -33445566;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ__N__RW), CO_TSIGNED32, (CO_DATA)(&data)};
    int32_t  var;
    CO_ERR   err;
...
{
    int32_t  var = -44556677;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TSIGNED32, (CO_DATA)(-11223344)};
    CO_ERR   err;

    err = COObjRdValue(&Obj, NULL, &var, sizeof(var));

    TEST_CHECK(err == CO_ERR_BAD_ARG);
    TEST_CHECK(var == -44556677);
}
...
void test_write_ref(void)
{
    ...
    int32_t  data = -11223344;
    CO_OBJ   Obj  = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TSIGNED32, (CO_DATA)(&data)};
    int32_t  var = -22334455;
    CO_ERR   err;

    err = COObjWrValue(&Obj, &AppNode, &var, sizeof(var));

    TEST_CHECK(err == CO_ERR_NONE);
    TEST_CHECK(data == -22334455);
}
...
void test_write_direct(void)
{
    CO_NODE  AppNode = { 0 };
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TSIGNED32, (CO_DATA)(-22334455)};
    int32_t  var = -33445566;
    CO_ERR   err;

    err = COObjWrValue(&Obj, &AppNode, &var, sizeof(var));

    TEST_CHECK(err == CO_ERR_NONE);
    TEST_CHECK((int32_t)Obj.Data == -33445566);
}
...
void test_write_pdo_async(void)
{
    CO_NODE  AppNode = { 0 };
    int32_t  data = -33445566;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ___APRW), CO_TSIGNED32, (CO_DATA)(&data)};
    int32_t  var = -44556677;
    CO_ERR   err;
...
void test_write_pdo(void)
{
    CO_NODE  AppNode = { 0 };
    int32_t  data = -33445566;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ____PRW), CO_TSIGNED32, (CO_DATA)(&data)};
    int32_t  var = -44556677;
    CO_ERR   err;

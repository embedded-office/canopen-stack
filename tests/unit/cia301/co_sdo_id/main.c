...
void test_size_unknown(void)
{
    CO_NODE  AppNode = { 0 };
    uint32_t data;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TSDO_ID, (CO_DATA)(&data)};
    uint32_t size;
...
void test_read_direct(void)
{
    ...
    uint32_t val  = 0;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TSDO_ID, (CO_DATA)(0x6677)};
...
void test_write_activate(void)
{
    ...
    CO_ERR   err;
    CO_OBJ   Obj[2] = {
        { CO_KEY(0x1200, 1, CO_OBJ_____RW), CO_TSDO_ID, (CO_DATA)(&data)},
        { CO_KEY(0x1200, 2, CO_OBJ_____RW), CO_TSDO_ID, (CO_DATA)(&data)}
    };
...
void test_write_bad_node(void)
{
    ...
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0x1200, 1, CO_OBJ_____RW), CO_TSDO_ID,  (CO_DATA)(&data)};
...
void test_init_bad_index(void)
{
    ...
    uint32_t data;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0x2345, 1, CO_OBJ_____RW), CO_TSDO_ID, (CO_DATA)(&data)};
...
void test_init_bad_sub(void)
{
    ...
    uint32_t data;
    CO_ERR   err;
    CO_OBJ   Obj = { CO_KEY(0x1200, 3, CO_OBJ_____RW), CO_TSDO_ID, (CO_DATA)(&data)};

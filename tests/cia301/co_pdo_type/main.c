...
void test_size_unknown(void)
{
    CO_NODE  AppNode = { 0 };
    uint8_t  data;
    CO_OBJ   Obj = { CO_KEY(0, 0, CO_OBJ_____RW), CO_TPDO_TYPE, (CO_DATA)(&data)};
    uint32_t size;
...
void test_read_direct(void)
{
    ...
    uint8_t val  = 0;
    CO_ERR  err;
    CO_OBJ  Obj = { CO_KEY(0, 0, CO_OBJ_D___RW), CO_TPDO_TYPE, (CO_DATA)(0x66)};
...
void test_write_num(void)
{
    ...
    CO_OBJ  Obj[2] = {
        ...
        { CO_KEY(0x1800, 2, CO_OBJ_____RW), CO_TPDO_TYPE, (CO_DATA)(&data)}
    };
...
void test_init_check(void)
{
    ...
    uint8_t data;
    CO_ERR  err;
    CO_OBJ  Obj = { CO_KEY(0x1800, 2, CO_OBJ_____RW), CO_TPDO_TYPE, (CO_DATA)(&data)};
...
void test_init_bad_index(void)
{
    ...
    uint8_t data;
    CO_ERR  err;
    CO_OBJ  Obj = { CO_KEY(0x2345, 2, CO_OBJ_____RW), CO_TPDO_TYPE, (CO_DATA)(&data)};
...
void test_init_bad_sub(void)
{
    ...
    uint8_t data;
    CO_ERR  err;
    CO_OBJ  Obj = { CO_KEY(0x1800, 3, CO_OBJ_____RW), CO_TPDO_TYPE, (CO_DATA)(&data)};
